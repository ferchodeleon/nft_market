...
import 'package:ntf_marketplace/screens/ntf_screen.dart';

class ImageListView extends StatefulWidget {
  ImageListView({Key? key, required this.startIndex, this.duration = 30})
      : super(key: key);
...
class _ImageTitle extends StatelessWidget {
  _ImageTitle({Key? key, required this.image}) : super(key: key);
